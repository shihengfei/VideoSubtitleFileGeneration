...
public class VideoControllerTest {
	...
	@ResponseBody
	public String videoProcessingURL(HttpServletRequest httpRequest,
		...
		// 通过 id 获取处理后的视频链接
		String url = getPlayerWidgetUrl(videoId);
		url = url.replace("\"", "");
		url = url.replace("\"", "");
		return url;
	}
	 ...
	 * @return 获取处理后的视频链接
	 */
	public String getPlayerWidgetUrl(String id) {
		HttpClient httpclient = HttpClients.createDefault();
		try {
			URIBuilder builder = new URIBuilder(
					"https://videobreakdown.azure-api.net/Breakdowns/Api/Partner/Breakdowns/" + id
							+ "/PlayerWidgetUrl");
